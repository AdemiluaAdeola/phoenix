    ...
    <div className="container animate-fade-slide">
      <div className="r2-score-hero">
        ...
        <div className="r2-score-row">
          <div className="r2-score-big">{data.score}</div>
          <div className="r2-score-denom">out of 100</div>
        </div>
        <div className="r2-archetype-badge">{archetype.name}</div>
              ...
              <div className="r2-dim-row" key={dimLabels[index]}>
                ...
                <div className="r2-dim-bar-wrap">
                  <div className="r2-dim-track">
                    <div className="r2-dim-fill" style={{ width: `${pct}%` }}></div>
      ...
      <div className="r2-split-section">
        ...
        <div className="r2-split-grid">
          <div className="r2-split-card r2-strength-card">
          ...
          <div className="r2-split-card r2-growth-card">
      ...
      <div className="r2-cta-block">
        <div className="r2-cta-top">
          ...
          <div className="r2-cta-buttons">
            <a href="https://www.phoenixclearinsight.com/book" className="r2-btn-primary">Book the Clarity Intensive — $497 →</a>
            <a href="https://www.phoenixclearinsight.com/discovery" className="r2-btn-secondary">Schedule a Free Discovery Call</a>
          </div>
